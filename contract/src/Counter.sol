...
contract Counter is BaseHook {
    ...
    {
        beforeSwapCount++;
        console2.log("beforeSwap", beforeSwapCount);
    ...
    {
        afterSwapCount++;
        console2.log("afterSwapCount", afterSwapCount);
        ...
        returns (bytes4)
    {
        ...
        console2.log("beforeModifyPositionCount", beforeModifyPositionCount);
    ...
    function afterModifyPosition(
        ...
        console2.log("afterModifyPositionCount", afterModifyPositionCount);
